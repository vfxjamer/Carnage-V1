...
//   Rewards:     VelocityBallToGoal(8), GoalReward(concede=-1, weight=50), TouchBall(20), SpeedTowardBall(3), FaceBall(1), Air(0.15), PickupBoost(0.5), TotalEnergy(0.55)
...
WeightedReward(new VelocityBallToGoalReward(), 8.0f),
		WeightedReward(new GoalReward(-1.0f), 50.0f),
		WeightedReward(new TouchBallReward(), 20.0f),
